...
void renderQuad3()
{
	...
	// positions
	glm::vec3 pos1 = glm::vec3(-7.0f, 4.0f, 4.0f);
	glm::vec3 pos2 = glm::vec3(-7.0f, -1.0f, 4.0f);
	glm::vec3 pos3 = glm::vec3(7.0f, -1.0f, 4.0f);
	glm::vec3 pos4 = glm::vec3(7.0f, 4.0f, 4.0f);
	// texture coordinates
	glm::vec2 uv1 = glm::vec2(0.0f, 1.0f);
	glm::vec2 uv2 = glm::vec2(0.0f, 0.0f);
	glm::vec2 uv3 = glm::vec2(1.0f, 0.0f);
	...
	if (quadVAO3 == 0)
	{
		render(quadVAO3, quadVBO3, pos1, pos2, pos3, pos4, uv1, uv2, uv3, uv4);
	}
